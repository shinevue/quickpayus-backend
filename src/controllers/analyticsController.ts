...
exports.counts = catchAsyncErrors(async (req: UserRequest, res: Response, next: NextFunction) => {
  const user = req.user;
...
exports.getBalanceInformation = catchAsyncErrors(async (req: UserRequest, res: Response, next: NextFunction) => {
